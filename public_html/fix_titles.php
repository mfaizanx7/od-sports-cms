...
// Ensure the homepage uses the top 4
for ($i = 1; $i <= 4; $i++) {
...
// Update About page 15 members with correct order and titles
for ($i = 1; $i <= 15; $i++) {
    if (isset($teamMembers[$i])) {
        ...
        // clear any old remaining entries
...
echo "Team order and titles fixed successfully for theme $theme!\n";
