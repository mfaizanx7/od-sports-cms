...
<body @if (BaseHelper::siteLanguageDirection() == 'rtl') dir="rtl" @endif class="flex flex-col min-h-screen">
    ...
    <header class="header_wrap @if (theme_option('enable_sticky_header', 'yes') == 'yes') fixed-top header_with_topbar @endif">
        ...
        <div class="relative sticky top-0 bg-white z-50">
            <nav class="bg-white">
                <div class="flex flex-col lg:flex-row gap-3  py-2 items-center container justify-between m-auto">
                    ...
                    <a class="text-4xl font-bold tracking-widest order-1 text-black" href="/">
                        <img src="{{ Storage::URL('general/final-ummatti-logo-06-3.webp') }}" class="max-h-[50px]" alt="">
                    </a>
            ...
            <!-- Mega Menu -->
            <section class="bg-white hidden absolute z-30 m-auto h-[543px] w-full top-[6.5rem] megaMenu" id="megaMenu">
                <div class="grid grid-cols-2 container max-h-[532px] mx-auto w-full  py-3">
                    <div class="grid grid-cols-2 gap-3">
                        <div
                            class="flex flex-col w-full gap-3 border-r pr-3 overflow-y-auto max-h-[532px] scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                @foreach ($categories as $category)
                                    <a href="{{ $category->url }}"
                                        class="flex items-center flex-col cursor-pointer gap-1 category" data-category="{{ strtolower($category->name) }}">
                                        <div
                    ...
                    <div>
                    <div
                        class="grid grid-cols-6 gap-y-6 border-r max-w-full overflow-y-scroll overflow-x-hidden max-h-[532px] scrollbar-thin"
                        style="align-items: start;">
                        @foreach ($products as $product)
                            <a href="{{ $product->url }}" class="flex items-center flex-col cursor-pointer gap-1 productMegaMenu max-h-[6rem]">
                                <div
                                    class="w-16 h-16 hover:shadow-md hover:scale-110 transition-all transition-100 bg-gray-100 rounded-full overflow-hidden">
