...
Route::group(['namespace' => 'Theme\Shopwise\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
            ...
            Route::get('ajax/wishlist', 'ShopwiseController@ajaxWishlist')
                ->name('public.ajax.wishlist');
...
Route::get('/', function () {
    $featuredProducts = \Botble\Ecommerce\Models\Product::where('status', 'published')
        ->where('is_featured', 1)
