...
<style>
    .breadcrumb_section.bg_gray.page-title-mini, .zoomContainer {
        display: none;
    }
</style>
...
<div class="section">
    <div class="container">
                ...
                <div class="pr_detail">
                    <div class="product_description">
                        ...
                        @if (EcommerceHelper::isReviewEnabled())
                            @if ($product->reviews_count > 0)
                                <div class="rating_wrap">
                                    <div class="rating">
                                        <div class="product_rate" style="width: {{ $product->reviews_avg * 20 }}%">
                                        </div>
                                    </div>
                        ...
                        <div class="cart_extra">
                            <form class="add-to-cart-form" method="POST"
                                ...
                                <div class="cart_btn">
                                    @if (EcommerceHelper::isCartEnabled())
                                        <button
                                            class="btn btn-fill-out add-to-cart-button @if ($product->isOutOfStock()) btn-disabled @endif"
                        ...
                        <ul class="product-meta">
                            ...
                            <li id="product-sku" @if (!$product->sku) style="display: none" @endif>
                                {{ __('SKU') }}: <span>{{ $product->sku }}</span></li>
                        ...
                        <div class="product_share">
                            ...
                            <ul class="social_icons">
                                <li><a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}&title={{ rawurldecode(strip_tags(SeoHelper::getDescription())) }}"
                                        target="_blank" title="{{ __('Share on Facebook') }}"><i
                                            class="ion-social-facebook"></i></a></li>
                                <li><a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ rawurldecode(strip_tags(SeoHelper::getDescription())) }}"
                                        target="_blank" title="{{ __('Share on Twitter') }}"><i
                                            class="ion-social-twitter"></i></a></li>
                                <li><a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(url()->current()) }}&summary={{ rawurldecode(strip_tags(SeoHelper::getDescription())) }}&source=Linkedin"
                                        title="{{ __('Share on
                        ...
                        @if (EcommerceHelper::isReviewEnabled())
                            <li class="nav-item">
                                <a class="nav-link" id="reviews-tab" data-toggle="tab" href="#reviews"
                                    role="tab" aria-controls="reviews" aria-selected="false">{{ __('Reviews') }}
                            ...
                            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                <div id="list-reviews">
                                    @if (count($product->review_images))
                                        <div class="my-3">
                                            <h5>{{ __('Images from customer (:count)', ['count' => count($product->review_images)]) }}
                                            </h5>
                                ...
                                <div class="review_form field_form mt-3">
                                    ...
                                    <div class="form-group col-12">
                                        <textarea class="form-control" name="comment" id="txt-comment" rows="4"
                                            placeholder="{{ __('Write your review') }}" @if (!auth('customer')->check()) disabled @endif></textarea>
                                    </div>
                                    <div class="form-group col-12">
                                                ...
                                                <div class="image-upload__uploader-container">
                                                    <div class="d-table">
                                                        <div class="image-upload__uploader">
                                                            ...
                                                            <div class="image-upload__text">{{ __('Upload photos') }}
                                                            </div>
        ...
        <div class="row shop_container grid mt-6">
            <div class="col-12">
                <div class="heading_s1">
