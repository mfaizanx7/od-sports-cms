                    ...
                    <div class="dashboard_menu">
                        <ul class="nav nav-tabs flex-column" role="tablist">
                            ...
                            @if (EcommerceHelper::isEnabledSupportDigitalProducts())
                                <li class="nav-item">
                                    <a class="nav-link @if (Route::currentRouteName() == 'customer.downloads' || Route::currentRouteName() == 'customer.downloads.view') active @endif" href="{{ route('customer.downloads') }}"><i class="ti-shopping-cart-full"></i>{{ __('Downloads') }}</a>
                                </li>
                            @endif
                            @if (EcommerceHelper::isOrderReturnEnabled())
                                <li class="nav-item">
                                    <a class="nav-link @if (Route::currentRouteName() == 'customer.order_returns' || Route::currentRouteName() == 'customer.order_returns.view') active @endif" href="{{ route('customer.order_returns') }}"><i class="ti-shopping-cart-full"></i>{{ __('Order return requests') }}</a>
                                </li>
                            @endif
                            <li class="nav-item">
